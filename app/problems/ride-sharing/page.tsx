...
export default function RideSharingPage() {
  return <LessonShell title="Ride Sharing" eyebrow="Problem 08 · Complete walkthrough" difficulty="Intermediate" duration="60 min" toc={toc} focusHref="/problems/ride-sharing/learn/" previous={{ href: "/problems/splitwise/", label: "Splitwise" }}><RideSharingLesson /></LessonShell>;
}
