...
export default function SplitwisePage() {
  return <LessonShell title="Splitwise" eyebrow="Problem 06 · Complete walkthrough" difficulty="Intermediate" duration="50 min" toc={toc} previous={{ href: "/problems/meeting-room-scheduler/", label: "Meeting Room Scheduler" }}><SplitwiseLesson /></LessonShell>;
}
